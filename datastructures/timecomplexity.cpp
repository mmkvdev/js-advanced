...
char* function3(int n) {
	...
	// this loop can get complicate d as this contaons harmonic progression which might be approximately equal to log n, but it is almost greater to the value of n
	return "O(n*logn)";
}
